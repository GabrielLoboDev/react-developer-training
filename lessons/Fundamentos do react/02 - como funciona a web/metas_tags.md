...
Meta tags são linhas de código HTML ou 'etiquetas' que, entre outras coisas, descrevem o conteúdo do site para os buscadores. É nelas que são inseridas as palavras-chave que facilitação a vida do usuário na hora de encontrar o site.
